  ...
  const renderMainItem = (item: NavItemType) => {
    return item.targetBlank ? (
      ...
      <NavLink
        ...
        strict
        rel="noopener noreferrer"
        className="inline-flex items-center rounded-full text-sm xl:text-base font-normal text-neutral-700 dark:text-neutral-300 py-2 px-4 xl:px-5  dark:hover:bg-neutral-800 dark:hover:text-neutral-200"
        to={{
          pathname: item.href || undefined,
        }}
